...
A git submodule of Effect-TS/effect, pinned to the tag matching the `effect` catalog (`effect@4.0.0-rc.115`) and managed by silk's repos tooling. Vendored as **read-only Effect v4 source for agents** — the authority on what v4 actually exports.
