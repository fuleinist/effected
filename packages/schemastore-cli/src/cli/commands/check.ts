 ...
 * i.e. whenever `build` would write anything — and on a catalog file no
 * schema declares (`orphaned`), the one failure `build` does not clear:
 * delete the file by hand, or restore a `catalog` block.
 *
 * @public
 */
