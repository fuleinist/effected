...
* [Companion package](companion-package.md) - A published, installable package that is not a library — its API is not why you install it, and it carries no tier; the pnpm plugin and the schemastore bin.
